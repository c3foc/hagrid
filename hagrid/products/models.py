...
class VariationAvailabilityEvent(models.Model):
    ...
    variation = models.ForeignKey(
        Variation, related_name="events", on_delete=models.CASCADE
    )
...
class VariationCountEvent(models.Model):
    ...
    datetime = models.DateTimeField(auto_now=True)
    variation = models.ForeignKey(
        Variation, related_name="count_events", on_delete=models.CASCADE
    )
...
class VariationCountAccessCode(models.Model):
    ...
    as_queue = models.BooleanField(
        help_text="use queue mode for this code", default=False
    )
