...
class ReservationEvent(models.Model):
    ...
    reservation = models.ForeignKey(
        Reservation, related_name="events", on_delete=models.CASCADE
    )
...
class ReservationPart(models.Model):
    ...
    reservation = models.ForeignKey(
        Reservation, related_name="parts", on_delete=models.CASCADE
    )
...
class ReservationPosition(models.Model):
    ...
    part = models.ForeignKey(
        ReservationPart, related_name="positions", on_delete=models.CASCADE
    )
